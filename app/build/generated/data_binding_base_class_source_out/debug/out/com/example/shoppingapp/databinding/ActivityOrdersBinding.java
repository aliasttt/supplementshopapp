...
public final class ActivityOrdersBinding implements ViewBinding {
  ...
  private ActivityOrdersBinding(@NonNull LinearLayout rootView, @NonNull TextView emptyView,
  ...
  public static ActivityOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOrdersBinding((LinearLayout) rootView, emptyView, recyclerView, toolbar);
    }
