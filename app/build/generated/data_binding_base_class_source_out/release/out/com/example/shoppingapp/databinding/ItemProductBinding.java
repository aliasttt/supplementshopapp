...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull MaterialCardView rootView, @NonNull TextView nameText,
      @NonNull TextView priceText, @NonNull ImageView productImage, @NonNull TextView stockText) {
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((MaterialCardView) rootView, nameText, priceText, productImage,
          stockText);
    }
