  ...
  public ProductDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfProduct = new EntityInsertionAdapter<Product>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `products` (`id`,`name`,`description`,`price`,`imageUrl`,`stockQuantity`,`category`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement, final Product entity) {
        ...
        statement.bindLong(6, entity.getStockQuantity());
    ...
    this.__updateAdapterOfProduct = new EntityDeletionOrUpdateAdapter<Product>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `products` SET `id` = ?,`name` = ?,`description` = ?,`price` = ?,`imageUrl` = ?,`stockQuantity` = ?,`category` = ? WHERE `id` = ?";
      }
      ...
      public List<Product> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Product(_tmpName,_tmpDescription,_tmpPrice,_tmpImageUrl,_tmpStockQuantity,_tmpCategory);
            final long _tmpId;
      ...
      public Product call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Product(_tmpName,_tmpDescription,_tmpPrice,_tmpImageUrl,_tmpStockQuantity,_tmpCategory);
            final long _tmpId;
            _tmpId = _cursor.getLong(_cursorIndexOfId);
