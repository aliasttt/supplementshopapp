...
import com.example.shoppingapp.dao.CartItemDao;
import com.example.shoppingapp.dao.CartItemDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `products` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `description` TEXT, `price` REAL NOT NULL, `imageUrl` TEXT, `stockQuantity` INTEGER NOT NULL, `category` TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `users` (`id` TEXT NOT NULL, `email` TEXT, `name` TEXT, `password` TEXT, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `categories` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT, `description` TEXT, `imageUrl` TEXT)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `cart_items` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `product_id` TEXT, `quantity` INTEGER NOT NULL, `user_email` TEXT, `product_name` TEXT, `product_price` REAL NOT NULL, `product_image_url` TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '64282df23435ded5e10fd0d599e475d7')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoCategories.equals(_existingCategories)) {
          return new RoomOpenHelper.ValidationResult(false, "categories(com.example.shoppingapp.models.Category).\n"
                  + " Expected:\n" + _infoCategories + "\n"
                  + " Found:\n" + _existingCategories);
        }
        ...
        _columnsCartItems.put("product_id", new TableInfo.Column("product_id", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsCartItems.put("product_image_url", new TableInfo.Column("product_image_url", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "64282df23435ded5e10fd0d599e475d7", "81ec9dd4b20fbc18dd2635acba999489");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "products","users","categories","orders","cart_items");
  }
